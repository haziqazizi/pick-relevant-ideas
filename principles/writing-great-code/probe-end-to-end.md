...
Prove the whole route, not only each component.

Use for workflows crossing UI, API, database, queue, external provider, browser,
or device boundaries.

A unit test can prove a branch. It cannot prove the route works for a user.
