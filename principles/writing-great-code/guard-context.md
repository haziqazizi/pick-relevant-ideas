...
Keep the main thread for decisions.

Use isolated exploration when:

- reading many files
- comparing candidates
- reviewing logs/traces
- searching broad history
- generating large artifacts

Bring back file paths, findings, and evidence, not dumps.
