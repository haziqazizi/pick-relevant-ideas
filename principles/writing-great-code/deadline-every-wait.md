...
Use for network calls, subprocesses, locks, queues, retries, browser waits,
device sessions, and CI/deploy polling.

State the timeout, retry policy, cancellation behavior, or reason blocking is
acceptable.
