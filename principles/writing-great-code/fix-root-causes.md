...
No fix without mechanism.

Required order:

1. Reproduce or force the symptom.
2. List hypotheses.
3. Eliminate hypotheses with runtime evidence.
4. Fix the smallest mechanism evidence supports.
5. Re-run the original reproduction.

Revert speculative changes that evidence refutes.
