...
Do not let competing stores, flags, docs, generated files, or caches
independently claim authority.

When duplication is necessary, name:

- the authoritative source
- how derived copies are regenerated
- how staleness is detected
- which file humans should edit
