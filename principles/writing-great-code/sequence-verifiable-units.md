...
Each unit should prove one claim.

Preferred order:

1. failing reproduction or baseline
2. scaffold or shared shape
3. implementation slice
4. verification
5. commit or handoff

If units cannot be independently verified, name the coupling and the final integrated proof.
