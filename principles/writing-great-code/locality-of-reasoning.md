...
Prefer designs where a reader can understand behavior from the smallest local
surface.

Use when adding indirection, shared state, callbacks, hooks, observers, or
cross-module control flow.

Avoid forcing future readers to chase distant files to answer:
