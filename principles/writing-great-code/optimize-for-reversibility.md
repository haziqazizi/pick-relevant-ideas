...
Prefer changes that can be rolled back, disabled, retried, replayed, or
re-generated.

Use for migrations, deploys, config changes, generated artifacts, and external
integrations.

If reversal is hard, make that risk explicit before acting.
