...
Compute the intended action before performing the effect.

Use for destructive writes, migrations, deploys, external posts, file deletes,
bulk edits, and generated output.

Prefer:

1. dry-run or plan
2. reviewable decision
3. small effect
4. verification
